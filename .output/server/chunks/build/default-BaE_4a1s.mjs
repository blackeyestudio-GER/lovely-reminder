import { ref, defineComponent, computed, watch, mergeProps, h, withCtx, createVNode, unref, shallowRef, useSSRContext, createTextVNode } from 'vue';
...
import { _ as __nuxt_component_0$1 } from './nuxt-link-MOZoSEA2.mjs';
        ...
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              _push2(`<span${_scopeId}>Aufgabe hinzuf\xFCgen</span>`);
            } else {
              return [
                createVNode(unref(Icon), {
                  icon: "heroicons:plus-circle-20-solid",
                ...
                createVNode("span", null, "Aufgabe hinzuf\xFCgen")
              ];
            }
          }),
          _: 1
...
//# sourceMappingURL=default-BaE_4a1s.mjs.map
